 ...
 */
class getReviewRatingRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ReviewRatingRepository' shared autowired service.
     *
     * @return \App\Repository\ReviewRatingRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ReviewRatingRepository.php';

        return $container->privates['App\\Repository\\ReviewRatingRepository'] = new \App\Repository\ReviewRatingRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
